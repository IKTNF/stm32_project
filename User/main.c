	...
	while (1)
	{
		...
		if (BlueSerial_RxFlag == 1)
		{
			...
			else if (strcmp(Tag, "slider") == 0)
			{
				...
				else if (strcmp(Name, "AngleTag") == 0)
				{
					AnglePID.Target = atof(Value);
				}
				...
				else if (strcmp(Name, "SpeedTag") == 0)
				{
				...
				else if (strcmp(Name, "RightPWM") == 0)
				{
					RightPWM = atof(Value);
				}
			}
		...
		BlueSerial_Printf("[plot,%f]", AnglePID.Error0);
	}
}
